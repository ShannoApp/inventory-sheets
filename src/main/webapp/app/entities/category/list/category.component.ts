...
export class CategoryComponent implements OnInit {
  ...
  protected loadFromBackendWithRouteInformations(): Observable<ICategory[]> {
  ...
  protected onResponseSuccess(response: ICategory[]): void {
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<ICategory[]> {
    this.isLoading = true;
