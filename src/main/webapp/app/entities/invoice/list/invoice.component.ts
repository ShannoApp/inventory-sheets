...
export class InvoiceComponent implements OnInit {
  ...
  constructor(
    ...
    this.invoiceService.invoiceListData$.subscribe(data => {
      if(data){
        console.log(data);
  ...
  view(invoice : IInvoice): void {
    this.invoice = invoice;
    this.openView = true;
  }

  protected loadFromBackendWithRouteInformations(): Observable<IInvoice[]> {
  ...
  protected onResponseSuccess(response: IInvoice[] | null): void {
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<IInvoice[]> {
    this.isLoading = true;
